...
def main():
    ...
    targets = [
        ('Aerodrome', 'OOMM/Plugins/TopSky Aerodrome/TopSkyMaps.txt'),
        ('Terminal', 'OOMM/Plugins/TopSky Terminal/TopSkyMaps.txt'),
        ('Enroute', 'OOMM/Plugins/TopSky Enroute/TopSkyMaps.txt'),
